      ...
      <div className="w-full flex flex-col items-center justify-center mt-4 style-pen text-lg mb-5">
        ...
        <div className="flex flex-row flex-wrap items-center justify-center mt-8 gap-4 w-full max-w-[1200px]">
          {data.Enfants.filter(
            ...
            <div
              key={product.id}
              className="relative shadow-light flex flex-col items-center justify-center gap-4 rounded-lg p-2 cursor-pointer hover:bg-green-200 hover:rouded-md hover:scale-105 transition-transform duration-200 hover:shadow-md flex-grow basis-[200px] max-w-[300px] aspect-square"
              style={{
