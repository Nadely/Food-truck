				...
				<div className="inline-block w-full flex flex-col items-center justify-center mt-10 font-serif text-lg gap-4 mb-5">
					<div className="flex flex-row items-center justify-center gap-8">
							<button className="border-2 border-black rounded-lg p-2 flex flex-col items-center justify-center" style={{ width: '200px', height: '200px' }}>
									<Image src="/belcanto-zero-meat.jpg" alt="Belcanto Zero Meat" width={100} height={100} />
									<p className="text-sm mt-1">Belcanto Zero Meat</p>
									<p className="text-sm mb-1">4,5€</p>
							...
							<button className="border-2 border-black rounded-lg p-2 flex flex-col items-center justify-center" style={{ width: '200px', height: '200px' }}>
									<Image src="/fricadelle-zero-meat.jpg" alt="Fricadelle Zero Meat" width={100} height={100} />
									<p className="text-sm mt-auto">Fricadelle Zero Meat</p>
									<p className="text-sm mb-auto">4€</p>
									<div className="flex flex-row items-center gap-4">
							...
							<button className="border-2 border-black rounded-lg p-2 flex flex-col items-center justify-center" style={{ width: '200px', height: '200px' }}>
									<Image src="/hamburger-zero-meat.jpg" alt="Hamburger Zero Meat" width={100} height={100} />
									<p className="text-sm mt-auto">Hamburger Zero Meat</p>
									<p className="text-sm mb-auto">4€</p>
									<div className="flex flex-row items-center gap-4">
							...
							<button className="border-2 border-black rounded-lg p-2 flex flex-col items-center justify-center" style={{ width: '200px', height: '200px' }}>
									<Image src="/poulycroc-vegi.jpg" alt="Poulycroc Vegi" width={100} height={100} />
									<p className="text-sm mt-auto">Poulycroc Vegi</p>
