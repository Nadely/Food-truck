    ...
    return (
        <div className="flex flex-col items-center justify-center mt-20 font-bold font-serif text-2xl">
            ...
            <div className="inline-block w-full flex flex-row items-center justify-center mt-20 font-serif text-lg gap-4 mb-5">
                ...
                <button className="button-purple items-center justify-center" style={{ width: '180px', height: '180px' }}>
                    <Link href="/frites">Frites</Link>
                </button>
                <button className="button-orange items-center justify-center" style={{ width: '180px', height: '180px' }}>
